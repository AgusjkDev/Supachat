/* Credits for this list to Andrew Kelley (andrewrk) */
const charsList = [
    { " ": "\u00A0" },
    { 0: "\u07C0" },
    {
...
export default charsList.reduce((acc, charList) => {
    const [char, specialChars] = Object.entries(charList)[0];

    const specialCharsValues = specialChars.split("").reduce((values, specialChar) => {
        return { ...values, [specialChar]: char };
    }, {});

    return { ...acc, ...specialCharsValues };
}, {});
